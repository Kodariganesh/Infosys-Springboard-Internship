...
def main():
    ...
    st.sidebar.markdown(
        "<h2 style='text-align: center; color: #60a5fa;'>Shield Core</h2>",
        unsafe_allow_html=True,
    )
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown(
        "<small style='color: #64748b;'>Customer Support Ticket Automation<br>Infosys Springboard Internship</small>",
        unsafe_allow_html=True,
    )
    ...
    if selected == "Issue Prevention Dashboard":
        ...
        total_escalated = len([t for t in tickets if t.get("escalation")])
        ...
        if submit:
            if not title or not body:
                ...
                if reason:
                    ...
                    st.success("Normal priority. No immediate escalation triggered.")
        ...
        st.subheader("GenAI Response Auto-Drafter")
        ...
        with st.form("response_form"):
            ...
            body = st.text_area("Ticket Body", placeholder="e.g. I ordered last week but did not get any update.")
